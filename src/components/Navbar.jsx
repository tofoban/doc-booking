...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between mt-4 py-4 text-sm mb-5 border-b border-b-gray-400'>
        ...
        <div className='flex items-center gap-4'>
            ...
            {/* mobile menu */}
            <div className={`${showMenu ? 'fixed w-full' : "h-0 w-0"} md:hidden right-0 top-0 button-0 z-20 overflow-hidden bg-white transition-all`}>
