    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm '> 
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Lorem ipsum dolor <br /> sit amet consectetur adipisicing elit. Illum, voluptatum?</p>
          <p className='text-gray-500'>Tel: (234) 8158830052 <br /> Email: Oban@gmail.com</p>
